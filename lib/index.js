 ...
 * @typedef {import('./client').ConnectParams} ConnectParams
 ...
 *
 * @param {Plugin[]} plugins
 * @param {(...args: ConnectParams) => Promise<Connection>} connect
 * @return {(...args: ConnectParams) => Promise<Connection>}
 */
const registerHooks = (plugins, connect) => {
    return function(url, socketOptions) {
